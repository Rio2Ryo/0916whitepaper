    ...
    <>
        ...
        <section className="mv-section mv-section--core-tech">
          <div className="mv-wrap">
            ...
            <div className="mv-system">
              <h3 className="mv-system__title">
                MOTHER VEGETABLES 培養システム
              </h3>
              ...
              <div className="mv-card">
                <div className="mv-col__grid">
                  <ul className="mv-list">
                    ...
                    <li>
                      技術ステータス：24時間365日自律運転による実証済み商業的実用性
                    </li>
                  </ul>
                  <ul className="mv-list">
        ...
        <section className="mv-section">
          <div className="mv-wrap">
            ...
            <div className="mv-card-deep">
              <p className="mv-p">
                MOTHER VEGETABLES
                PROJECTは、環境保全と持続可能な未来を両立させる革新的なプロジェクトです。透明性のある測定可能な環境インパクトを提供しながら、CO₂吸収連動型システムを通じて参加者が地球の健康回復に直接貢献できる仕組みを提供します。
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="mv-wrap">
            ...
            <div className="mv-double-card__grid">
              <div className="mv-card-deep">
                ...
                <p className="mv-p">
                  当社は、Initial Exchange Offering
                  (IEO)およびトークンの市場流通を通じて資金調達を実施し、その資金を生産拠点の新規建設・拡張に充当します。
                </p>
                <p className="mv-p">
                  保有者は、当プロジェクトが発行する「MOTHER VEGETABLES Token
                  (MVT)」をスマートコントラクトに基づくステーキングプールへ預け入れることで、当社生産施設において実際に吸収されたCO₂量に連動したNFTを受け取ることができます。このNFTは、CO₂吸収の成果をブロックチェーン上で透明性高く証明するデジタルアセットであり、ステーキング参加者へのリワード（返礼）として付与されます。
                </p>
              </div>
              <div className="mv-card-deep">
            ...
            <div className="mv-issue-solution__container">
              ...
              <div className="mv-issue-solution__grid">
                <div className="mv-issue-solution__card">
                  ...
                  <ul className="mv-list--issue">
                    <li>
                      気候変動への関心は高まっているものの、個人・企業が直接的にCO₂削減に参加できる仕組みが不足している。
                    </li>
                    <li>
                      環境貢献活動の成果が定量化されず、一般社会に正しく認知されにくい。
                    </li>
                    <li>
                      環境テクノロジーへの投資機会が限定的で、一般投資家の参入障壁が高い。
                    </li>
                  </ul>
                </div>
                <div className="mv-issue-solution__card mv-issue-solution__card--solution">
                  ...
                  <ul className="mv-list--solution">
                    <li>
                      ステーキングとNFTを通じて、誰でもCO₂削減活動に経済的に参加できる分散型プラットフォームを提供。
                    </li>
                    <li>
                      ブロックチェーンにCO₂吸収量を記録し、環境貢献を可視化・証明。
                    </li>
                    <li>
                      小口投資から参加可能な形で、環境関連ビジネスへの投資領域を拡大。
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="mv-issue-solution__grid">
                <div className="mv-issue-solution__card">
                  ...
                  <ul className="mv-list--issue">
                    <li>
                      再生可能資源・環境保全技術の普及には多額の初期投資が必要であり、資金調達が課題。
                    </li>
                    <li>
                      環境貢献が直接的な収益モデルに結びつかず、事業の持続可能性が確保しにくい。
                    </li>
                    <li>
                      カーボンクレジット市場は複雑かつ閉鎖的で、小規模事業者や個人が参加しづらい。
                    </li>
                  </ul>
                </div>
                <div className="mv-issue-solution__card mv-issue-solution__card--solution">
                  ...
                  <ul className="mv-list--solution">
                    <li>
                      IEOおよびトークンエコノミクスを活用した国際的な資金調達スキームを構築。
                    </li>
                    <li>
                      NFTを活用し、環境価値をデジタル資産として市場取引可能にすることで、持続的な収益基盤を確保。
                    </li>
                    <li>
                      オープンかつ透明性の高いCO₂削減価値取引の仕組みを提供し、広範な市場参加を促進。
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="mv-issue-solution__grid">
                <div className="mv-issue-solution__card">
                  ...
                  <ul className="mv-list--issue">
                    <li>
                      世界的なCO₂排出量増加による地球温暖化の加速。
                    </li>
                    <li>
                      自然環境によるCO₂吸収能力の限界（森林伐採・土地利用変化による吸収源の減少）。
                    </li>
                    <li>
                      既存のCO₂削減プロジェクトは地域限定的で、グローバルスケールでの即効性に欠ける。
                    </li>
                  </ul>
                </div>
                <div className="mv-issue-solution__card mv-issue-solution__card--solution">
                  ...
                  <ul className="mv-list--solution">
                    <li>
                      藻類培養技術による24時間365日の安定的なCO₂吸収システムを世界各地に展開。
                    </li>
                    <li>
                      均一化生産システムにより、吸収効率の高い施設を短期間で複数拠点に展開可能。
                    </li>
                    <li>
                      吸収量データをリアルタイムでブロックチェーンに記録し、世界規模で環境効果を可視化。
                    </li>
                  </ul>
                </div>
              </div>
      ...
      <style jsx>{`
        :root {
          ...
          --muted: #9fb0c9;
          --dot: #a887ff;
          --note-grad: linear-gradient(
            135deg,
            rgba(39, 193, 141, 0.12),
        ...
        .mv-system__card--blue {
          background: radial-gradient(
            circle,
            rgba(46, 107, 184, 0.25) 0%,
            rgba(31, 78, 133, 0.15) 100%
          );
        }
        .mv-system__card--green {
          background: radial-gradient(
            circle,
            rgba(39, 193, 141, 0.25) 0%,
            rgba(26, 168, 108, 0.15) 100%
          );
        }
        .mv-system__icon {
          width: 56px;
        ...
        .mv-double-card__grid > .mv-card-deep {
          margin: 0;
        }

        .mv-issue-solution__container {
          margin-top: 32px;
        }
        ...
        .mv-issue-solution__category:first-of-type {
            margin-top: 0;
        }
        .mv-issue-solution__grid {
          display: grid;
          grid-template-columns: 1fr;
          gap: 24px;
        }
        ...
        .mv-issue-solution__card h4 {
          margin: 0 0 16px;
          font-size: 16px;
          font-weight: bold;
          color: #f36653; /* Red for issue */
        }
        .mv-issue-solution__card--solution h4 {
          color: #27c18d; /* Green for solution */
        }
        .mv-list--issue,
        .mv-list--solution {
          list-style: none;
        ...
        .mv-list--issue li + li,
        .mv-list--solution li + li {
          margin-top: 16px;
        }

        .mv-list--issue li::before {
          content: "▶";
          color: #f36653;
          position: absolute;
          left: 0;
